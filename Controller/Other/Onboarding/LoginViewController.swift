...
class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        createButton.addTarget(self, action: #selector(didClickCreateAccountButton), for: .touchUpInside)
    ...
    override func viewDidLayoutSubviews() {
        ...
        termsButton.frame = CGRect(x: 10, y: view.height-view.safeAreaInsets.bottom-100, width: view.width-20, height: 52.0)
        privacyButton.frame = CGRect(x: 25, y: view.height-view.safeAreaInsets.bottom-150, width: view.width-20, height: 52.0)
        configureHeaderView()
        }
        private func configureHeaderView(){
            ...
            imageView.frame = CGRect(x: 0, y: view.safeAreaInsets.top, width: headerView.width, height: headerView.height)
        }
